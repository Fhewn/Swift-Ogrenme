...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource  {
        ...
        do{
            ...
            if results.count > 0 {
                ...
                for result in results as! [NSManagedObject]{
                    ...
                    if let id = result.value(forKey: "recid") as? UUID{
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            let appDelegate = UIApplication.shared.delegate as! AppDelegate
            let context = appDelegate.persistentContainer.viewContext
            let fetchRequest: NSFetchRequest<NSFetchRequestResult> = NSFetchRequest(entityName: "Paintings")
            ...
            do{
                ...
                if results.count > 0{
                    for results in results as! [NSManagedObject]{
                        ...
                        if let id = results.value(forKey: "recid") as? UUID {
